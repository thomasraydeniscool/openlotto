<template>
  <div class="about">
    ...
    <p>You need to be quick though because the bonus is reduced by 1% for each subsequent bet. This means that by the 11th bet the bonus will be gone.</p>
    <h4>If each user gets 1% for each bet, when there are more than 100 bets isn't it mathmaticly impossible.</h4>
    <p>When the sum of all the draw's bets probabilities reaches 100%, on the event of another bet, all the bets probabilities are reduced evenly to make space for more bets. If you received a bonus your weighting will always stay the same <strong>proportionally</strong>.</p>
  </div>
</template>
